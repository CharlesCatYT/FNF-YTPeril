...
class DiscordClient
{
	...
	private static var _defaultID:String = "1120815399378878484";
	...
	private static var _options:Dynamic = {
		...
		state: null,
		largeImageKey: 'icon',
		largeImageText: "Youtube Animation Peril",
		smallImageKey : null,
		startTimestamp : null,
		endTimestamp : null
	};
	...
	public static function changePresence(details:String, state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		_options.largeImageText = "Mod Version: " + states.MainMenuState.ytPerilVersion;
